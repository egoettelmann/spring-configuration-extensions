...
public class Sample2SpringConfigurationPropertiesTest {

    /**
     * Verifies the metadata generated by `spring-boot-configuration-processor`.
     * Checks that `META-INF/spring-configuration-metadata.json` matches `spring-configuration-metadata-test-sample2.json`.
     *
    ...
    public void testSpringConfigurationProperties() throws Exception {
        ...
        final File expectedFile = ResourceUtils.getFile("classpath:spring-configuration-metadata-test-sample2.json");
