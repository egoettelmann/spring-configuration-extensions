...
public class AdditionalConfigurationPropertiesTest {
    ...
    public void testAdditionalConfigurationProperties() throws Exception {
        ...
        final File expectedFile = ResourceUtils.getFile("classpath:additional-spring-configuration-metadata-test-1.json");
