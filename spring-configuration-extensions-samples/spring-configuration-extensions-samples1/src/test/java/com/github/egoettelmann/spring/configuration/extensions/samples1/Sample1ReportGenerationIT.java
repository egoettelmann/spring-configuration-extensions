package com.github.egoettelmann.spring.configuration.extensions.samples1;
...
public class Sample1ReportGenerationIT {

    /**
     * Verifies the report generated by `spring-configuration-aggregator-maven-plugin`.
     * Checks that `spring-configuration-extensions-samples1-*-configurations.json` matches `report-test-sample1.json`.
     *
    ...
    public void testReportGeneration() throws Exception {
        ...
        final File generatedFile = ResourceUtils.getFile("target/spring-configuration-extensions-samples1-" + version + "-configurations.json");
        try (final InputStream expectedIS = new ClassPathResource("report-test-sample1.json").getInputStream()) {
    ...
    private String getProjectVersion() throws Exception {
        try (InputStream is = getClass().getResourceAsStream("/META-INF/maven/com.github.egoettelmann/spring-configuration-extensions-samples1/pom.properties")) {
