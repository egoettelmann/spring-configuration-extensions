...
public class Sample1AdditionalConfigurationPropertiesTest {
     ...
     * Checks that `META-INF/additional-spring-configuration-metadata.json` matches `additional-spring-configuration-metadata-test-sample1.json`.
     *
    ...
    public void testAdditionalConfigurationProperties() throws Exception {
        ...
        final File expectedFile = ResourceUtils.getFile("classpath:additional-spring-configuration-metadata-test-sample1.json");
