...
public class Sample1AggregatedConfigurationPropertiesIT {

    /**
     * Verifies the aggregated metadata generated by `spring-configuration-aggregator-maven-plugin`.
     * Checks that `META-INF/aggregated-spring-configuration-metadata.json` matches `aggregated-spring-configuration-metadata-test-sample1.json`.
     *
    ...
    public void testAggregatedConfigurationProperties() throws Exception {
        try (
                ...
                final InputStream expectedIS = new ClassPathResource("aggregated-spring-configuration-metadata-test-sample1.json").getInputStream()
        ) {
